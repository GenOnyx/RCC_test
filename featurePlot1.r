...
markers = c("PTPRC", "CD14", "TMEM119", "CD163", "LYZ", "CD3E", "NKG7", "CD79A",
            "IFITM2", "S100A8", "PLP1", "PTPRZ1", "OLIG2", "MKI67", "CHI3L1",
            "VEGFA", "HILPDA", "PDGFRA", "EGFR", "DCN", "STMN2", "GFAP", "HAMP")
...
for(counts in 1:nrow(coordsF)){
  ...
  png(paste0("Level",counts + 1, "_selGenes.png"), width = 1000, height = 1000)
    print(FeaturePlot(data, reduction = "numap", features = markers, cols = c("lightgrey", "red")))
  dev.off()
}
